...
notes_to_songs = {tuple(['E5', 'E5', 'F5']) : "Beethhoven_editedSimple.mid",
                  tuple(['C6', 'C6', 'C6']): "kanye_lower.mid"}
...
class PlaySongNode(Node):
    ...
    def __init__(self):
        ...
        self.pub = self.create_publisher(String, '/song_cmd', 30)
            ...
            for msg in inport:
                if msg.type == 'note_off':
                    ...
                    if tuple(self.last_three_notes) in notes_to_songs:
                        song = notes_to_songs[tuple(self.last_three_notes)]
